...
public class Drucksache {
  ...
  public Drucksache id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public Drucksache typ(@javax.annotation.Nonnull TypEnum typ) {
    this.typ = typ;
    return this;
  }
  ...
  public Drucksache dokumentart(@javax.annotation.Nonnull DokumentartEnum dokumentart) {
  ...
  public Drucksache drucksachetyp(@javax.annotation.Nonnull String drucksachetyp) {
  ...
  public Drucksache dokumentnummer(@javax.annotation.Nonnull String dokumentnummer) {
  ...
  public Drucksache wahlperiode(@javax.annotation.Nullable Integer wahlperiode) {
  ...
  public Drucksache herausgeber(@javax.annotation.Nonnull HerausgeberEnum herausgeber) {
  ...
  public Drucksache datum(@javax.annotation.Nonnull LocalDate datum) {
    this.datum = datum;
    return this;
  }
  ...
  public Drucksache aktualisiert(@javax.annotation.Nonnull OffsetDateTime aktualisiert) {
  ...
  public Drucksache titel(@javax.annotation.Nonnull String titel) {
    this.titel = titel;
    return this;
  }
  ...
  public Drucksache autorenAnzeige(@javax.annotation.Nullable List<DrucksacheAutorenAnzeigeInner> autorenAnzeige) {
    this.autorenAnzeige = autorenAnzeige;
    return this;
  }

  public Drucksache addAutorenAnzeigeItem(DrucksacheAutorenAnzeigeInner autorenAnzeigeItem) {
  ...
  public Drucksache autorenAnzahl(@javax.annotation.Nonnull Integer autorenAnzahl) {
  ...
  public Drucksache fundstelle(@javax.annotation.Nonnull Fundstelle fundstelle) {
  ...
  public Drucksache pdfHash(@javax.annotation.Nullable String pdfHash) {
  ...
  public Drucksache urheber(@javax.annotation.Nullable List<Urheber> urheber) {
    this.urheber = urheber;
    return this;
  }

  public Drucksache addUrheberItem(Urheber urheberItem) {
  ...
  public Drucksache vorgangsbezug(@javax.annotation.Nullable List<Vorgangsbezug> vorgangsbezug) {
    this.vorgangsbezug = vorgangsbezug;
    return this;
  }

  public Drucksache addVorgangsbezugItem(Vorgangsbezug vorgangsbezugItem) {
  ...
  public Drucksache vorgangsbezugAnzahl(@javax.annotation.Nonnull Integer vorgangsbezugAnzahl) {
  ...
  public Drucksache ressort(@javax.annotation.Nullable List<Ressort> ressort) {
    this.ressort = ressort;
    return this;
  }

  public Drucksache addRessortItem(Ressort ressortItem) {
  ...
  public Drucksache anlagen(@javax.annotation.Nullable String anlagen) {
  ...
  public boolean equals(Object o) {
    ...
    Drucksache drucksache = (Drucksache) o;
    return Objects.equals(this.id, drucksache.id) &&
        Objects.equals(this.typ, drucksache.typ) &&
        Objects.equals(this.dokumentart, drucksache.dokumentart) &&
        Objects.equals(this.drucksachetyp, drucksache.drucksachetyp) &&
        Objects.equals(this.dokumentnummer, drucksache.dokumentnummer) &&
        Objects.equals(this.wahlperiode, drucksache.wahlperiode) &&
        Objects.equals(this.herausgeber, drucksache.herausgeber) &&
        Objects.equals(this.datum, drucksache.datum) &&
        Objects.equals(this.aktualisiert, drucksache.aktualisiert) &&
        Objects.equals(this.titel, drucksache.titel) &&
        Objects.equals(this.autorenAnzeige, drucksache.autorenAnzeige) &&
        Objects.equals(this.autorenAnzahl, drucksache.autorenAnzahl) &&
        Objects.equals(this.fundstelle, drucksache.fundstelle) &&
        Objects.equals(this.pdfHash, drucksache.pdfHash) &&
        Objects.equals(this.urheber, drucksache.urheber) &&
        Objects.equals(this.vorgangsbezug, drucksache.vorgangsbezug) &&
        Objects.equals(this.vorgangsbezugAnzahl, drucksache.vorgangsbezugAnzahl) &&
        Objects.equals(this.ressort, drucksache.ressort) &&
        Objects.equals(this.anlagen, drucksache.anlagen);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, typ, dokumentart, drucksachetyp, dokumentnummer, wahlperiode, herausgeber, datum, aktualisiert, titel, autorenAnzeige, autorenAnzahl, fundstelle, pdfHash, urheber, vorgangsbezug, vorgangsbezugAnzahl, ressort, anlagen);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Drucksache {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Drucksache
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Drucksache.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Drucksache is not found in the empty JSON string", Drucksache.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Drucksache.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Drucksache` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Drucksache.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Drucksache.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Drucksache' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Drucksache> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Drucksache.class));

       return (TypeAdapter<T>) new TypeAdapter<Drucksache>() {
           @Override
           public void write(JsonWriter out, Drucksache value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Drucksache read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Drucksache given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Drucksache
   * @throws IOException if the JSON string is invalid with respect to Drucksache
   */
  public static Drucksache fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Drucksache.class);
  }

  /**
   * Convert an instance of Drucksache to an JSON string
   *
   * @return JSON string
   */
