...
public class Plenarprotokoll {
	...
	public static final String SERIALIZED_NAME_XML_HASH = "xml_hash";
	...
	public Plenarprotokoll() {
	}

	public Plenarprotokoll id(@javax.annotation.Nonnull String id) {
		this.id = id;
		return this;
	}
	...
	public Plenarprotokoll dokumentart(@javax.annotation.Nonnull DokumentartEnum dokumentart) {
	...
	public Plenarprotokoll typ(@javax.annotation.Nonnull TypEnum typ) {
		this.typ = typ;
		return this;
	}
	...
	public Plenarprotokoll dokumentnummer(@javax.annotation.Nonnull String dokumentnummer) {
	...
	public Plenarprotokoll wahlperiode(@javax.annotation.Nullable Integer wahlperiode) {
	...
	public Plenarprotokoll herausgeber(@javax.annotation.Nonnull Zuordnung herausgeber) {
	...
	public Plenarprotokoll datum(@javax.annotation.Nonnull LocalDate datum) {
		this.datum = datum;
		return this;
	}
	...
	public Plenarprotokoll aktualisiert(@javax.annotation.Nonnull OffsetDateTime aktualisiert) {
	...
	public Plenarprotokoll titel(@javax.annotation.Nonnull String titel) {
		this.titel = titel;
		return this;
	}
	...
	public Plenarprotokoll fundstelle(@javax.annotation.Nonnull Fundstelle fundstelle) {
	...
	public Plenarprotokoll pdfHash(@javax.annotation.Nullable String pdfHash) {
	...
	public Plenarprotokoll xmlHash(@javax.annotation.Nullable String xmlHash) {
		this.xmlHash = xmlHash;
		return this;
	}

	/**
	 * MD5-Prüfsumme der XML-Datei
	 *
	 * @return xmlHash
	 */
	@javax.annotation.Nullable
	...
	public void setXmlHash(@javax.annotation.Nullable String xmlHash) {
		this.xmlHash = xmlHash;
	}

	public Plenarprotokoll vorgangsbezug(@javax.annotation.Nullable List<Vorgangsbezug> vorgangsbezug) {
		this.vorgangsbezug = vorgangsbezug;
		return this;
	}

	public Plenarprotokoll addVorgangsbezugItem(Vorgangsbezug vorgangsbezugItem) {
	...
	public Plenarprotokoll vorgangsbezugAnzahl(@javax.annotation.Nonnull Integer vorgangsbezugAnzahl) {
	...
	public Plenarprotokoll sitzungsbemerkung(@javax.annotation.Nullable String sitzungsbemerkung) {
	...
	public boolean equals(Object o) {
		...
		Plenarprotokoll plenarprotokoll = (Plenarprotokoll) o;
		return Objects.equals(this.id, plenarprotokoll.id) &&
				Objects.equals(this.dokumentart, plenarprotokoll.dokumentart) &&
				Objects.equals(this.typ, plenarprotokoll.typ) &&
				Objects.equals(this.dokumentnummer, plenarprotokoll.dokumentnummer) &&
				Objects.equals(this.wahlperiode, plenarprotokoll.wahlperiode) &&
				Objects.equals(this.herausgeber, plenarprotokoll.herausgeber) &&
				Objects.equals(this.datum, plenarprotokoll.datum) &&
				Objects.equals(this.aktualisiert, plenarprotokoll.aktualisiert) &&
				Objects.equals(this.titel, plenarprotokoll.titel) &&
				Objects.equals(this.fundstelle, plenarprotokoll.fundstelle) &&
				Objects.equals(this.pdfHash, plenarprotokoll.pdfHash) &&
				Objects.equals(this.xmlHash, plenarprotokoll.xmlHash) &&
				Objects.equals(this.vorgangsbezug, plenarprotokoll.vorgangsbezug) &&
				Objects.equals(this.vorgangsbezugAnzahl, plenarprotokoll.vorgangsbezugAnzahl) &&
				Objects.equals(this.sitzungsbemerkung, plenarprotokoll.sitzungsbemerkung);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, dokumentart, typ, dokumentnummer, wahlperiode, herausgeber, datum, aktualisiert, titel,
				fundstelle, pdfHash, xmlHash, vorgangsbezug, vorgangsbezugAnzahl, sitzungsbemerkung);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class Plenarprotokoll {\n");
	...
	public static void validateJsonElement(JsonElement jsonElement) throws IOException {
		if (jsonElement == null) {
			if (!Plenarprotokoll.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
				throw new IllegalArgumentException(
						String.format("The required field(s) %s in Plenarprotokoll is not found in the empty JSON string",
								Plenarprotokoll.openapiRequiredFields.toString()));
			}
		}
		...
		for (Map.Entry<String, JsonElement> entry : entries) {
			if (!Plenarprotokoll.openapiFields.contains(entry.getKey())) {
				throw new IllegalArgumentException(String.format(
						"The field `%s` in the JSON string is not defined in the `Plenarprotokoll` properties. JSON: %s",
		...
		// string
		for (String requiredField : Plenarprotokoll.openapiRequiredFields) {
		...
		if (!jsonObj.get("typ").isJsonPrimitive()) {
			throw new IllegalArgumentException(
					String.format("Expected the field `typ` to be a primitive type in the JSON string but got `%s`",
							jsonObj.get("typ").toString()));
		}
		...
		if (!jsonObj.get("titel").isJsonPrimitive()) {
			throw new IllegalArgumentException(
					String.format("Expected the field `titel` to be a primitive type in the JSON string but got `%s`",
							jsonObj.get("titel").toString()));
		}
		// validate the required field `fundstelle`
		Fundstelle.validateJsonElement(jsonObj.get("fundstelle"));
		if ((jsonObj.get("pdf_hash") != null && !jsonObj.get("pdf_hash").isJsonNull())
				&& !jsonObj.get("pdf_hash").isJsonPrimitive()) {
			throw new IllegalArgumentException(
					String.format("Expected the field `pdf_hash` to be a primitive type in the JSON string but got `%s`",
							jsonObj.get("pdf_hash").toString()));
		}
		if (jsonObj.get("vorgangsbezug") != null && !jsonObj.get("vorgangsbezug").isJsonNull()) {
			...
			if (jsonArrayvorgangsbezug != null) {
				...
				if (!jsonObj.get("vorgangsbezug").isJsonArray()) {
					throw new IllegalArgumentException(
							String.format("Expected the field `vorgangsbezug` to be an array in the JSON string but got `%s`",
									jsonObj.get("vorgangsbezug").toString()));
				}
		...
		if ((jsonObj.get("sitzungsbemerkung") != null && !jsonObj.get("sitzungsbemerkung").isJsonNull())
				&& !jsonObj.get("sitzungsbemerkung").isJsonPrimitive()) {
			throw new IllegalArgumentException(
					String.format("Expected the field `sitzungsbemerkung` to be a primitive type in the JSON string but got `%s`",
							jsonObj.get("sitzungsbemerkung").toString()));
		}
	}
	...
	public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
		...
		public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
			if (!Plenarprotokoll.class.isAssignableFrom(type.getRawType())) {
				return null; // this class only serializes 'Plenarprotokoll' and its subtypes
			}
			final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
			final TypeAdapter<Plenarprotokoll> thisAdapter = gson.getDelegateAdapter(this,
					TypeToken.get(Plenarprotokoll.class));

			return (TypeAdapter<T>) new TypeAdapter<Plenarprotokoll>() {
				@Override
				public void write(JsonWriter out, Plenarprotokoll value) throws IOException {
					JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
					elementAdapter.write(out, obj);
				}

				@Override
				public Plenarprotokoll read(JsonReader in) throws IOException {
	...
	/**
	 * Create an instance of Plenarprotokoll given an JSON string
	 *
	 * @param jsonString JSON string
	 * @return An instance of Plenarprotokoll
	 * @throws IOException if the JSON string is invalid with respect to
	 *                     Plenarprotokoll
	 */
	public static Plenarprotokoll fromJson(String jsonString) throws IOException {
		return JSON.getGson().fromJson(jsonString, Plenarprotokoll.class);
	}

	/**
	 * Convert an instance of Plenarprotokoll to an JSON string
	 *
	 * @return JSON string
	 */
